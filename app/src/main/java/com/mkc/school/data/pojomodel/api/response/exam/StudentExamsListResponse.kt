...
data class StudentExamsListResponse(
    ...
    @field:JsonProperty("attachment_link")
    @field:SerializedName("attachment_link")
    val attachment_link: String? = null,
    ...
    @field:JsonProperty("exam_schedule")
    @field:SerializedName("exam_schedule")
    val exam_schedule: String? = null,
    ...
    @field:JsonProperty("exam_attended")
    @field:SerializedName("exam_attended")
    val exam_attended: Boolean? = null,

    @field:JsonProperty("student_subject_marks")
    @field:SerializedName("student_subject_marks")
    val student_subject_marks: StudentSubjectMarks? = null,

    @field:JsonProperty("grade_details")
    @field:SerializedName("grade_details")
    val grade_details: ArrayList<GradeDetails>? = null
