...
class LiveclassAdapter(
    ...
    var liveClassList: ArrayList<LiveclassModel>,
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tvSubject.setText(liveClassList.get(position).classSubject)
        holder.tvTeacher.setText(liveClassList.get(position).classTeacher)
    }
